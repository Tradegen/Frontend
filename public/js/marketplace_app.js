...
function buildTable()
{
    ...
    for (let i = start; i > end; i--)
    {
        ...
        marketPrice.innerText = FILTERED_LISTINGS[i].sharePrice.toFixed(4) + " QOIN";
        ...
        advertisedPrice.innerText = FILTERED_LISTINGS[i].listingPrice.toFixed(4) + " QOIN";
...
function buildPanels()
{
    ...
    for (let i = start; i > end; i--)
    {
        ...
        currentPriceData.innerText = LISTINGS[i].sharePrice.toFixed(4) + " QOIN";
        ...
        advertisedPriceData.innerText = LISTINGS[i].listingPrice.toFixed(4) + " QOIN";
